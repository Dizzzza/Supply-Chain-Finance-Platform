  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Счета и финансирование</h1>
              ...
              {invoices.map((invoice) => (
                <tr key={invoice.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    ...
                    <button className="text-green-600 hover:text-green-900">Отправить напоминание</button>
                  </td>
                </tr>
              ))}
            </tbody>
