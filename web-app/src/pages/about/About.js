  ...
  const features = [
    {
      ...
      description: 'Автоматизация и безопасное исполнение контрактов между участниками системы'
    },
    {
    ...
    },
    {
      ...
      title: 'Безопасность',
      description: 'Защита данных и транзакций с использованием блокчейн-технологий'
    },
    {
      icon: <FaChartLine className="w-8 h-8 text-blue-600" />,
      title: 'Аналитика',
      description: 'Детальная аналитика и отчетность по всем финансовым операциям'
    },
    {
      icon: <FaGlobe className="w-8 h-8 text-blue-600" />,
      title: 'Мультивалютность',
      description: 'Поддержка расчетов в различных валютах и криптовалютах'
    },
    {
      icon: <FaShieldAlt className="w-8 h-8 text-blue-600" />,
      title: 'Прозрачность',
      description: 'Неизменяемый реестр всех транзакций и полная прозрачность операций'
    }
  ];
    ...
    >
      ...
      >
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Децентрализованная система для обеспечения прозрачных и безопасных финансовых операций между поставщиками и компаниями
        </p>
      </motion.div>
      ...
      >
        <h2 className="text-3xl font-bold mb-6">Цели проекта</h2>
        <p className="text-lg mb-6">
          Создание децентрализованной системы, обеспечивающей прозрачность, безопасность и эффективность 
          финансовых операций между поставщиками, покупателями и финансовыми организациями. Платформа 
          предоставляет неизменяемый реестр транзакций, поддерживает мультивалютные расчеты, автоматизирует 
          исполнение контрактов через смарт-контракты и гарантирует высокий уровень защиты данных.
        </p>
        <h2 className="text-3xl font-bold mb-6">Наше видение</h2>
        <p className="text-lg">
          Стать ведущей платформой для проведения безопасных и прозрачных финансовых операций между 
          бизнес-партнерами, используя преимущества блокчейн-технологий для обеспечения доверия и 
          эффективности в деловых отношениях.
        </p>
      </motion.div>
